...
parser.add_argument("-x", "--x-file-path", type=str, default="C:/Users/maksi/Documents/Statistics/Projects/Movement_Mental_Health/hyperaktiv/hyperaktiv_with_controls/hyperaktiv_with_controls/features.csv") # features 
parser.add_argument("-y", "--y-file-path", type=str, default="C:/Users/maksi/Documents/Statistics/Projects/Movement_Mental_Health/hyperaktiv/hyperaktiv_with_controls/hyperaktiv_with_controls/patient_info.csv") # patient info
parser.add_argument("-o", "--output-file-path", type=str, default="results_adhd_pred.txt")
